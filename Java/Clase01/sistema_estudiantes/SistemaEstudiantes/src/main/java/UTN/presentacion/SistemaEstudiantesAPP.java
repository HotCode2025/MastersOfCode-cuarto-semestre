        ...
        switch (opcion) {
            ...
            case 2 -> {
                ...
                if (encontrado) {
                    ...
                    System.out.println("No se encontro el estudiante con ID: " + idEstudiante);
                }
            }
            case 3 -> {
                // Agregar Estudiante
            ...
            case 4 -> {
                ...
                var estudiante = new Estudiante(idEstudiante, nuevoNombre, nuevoApellido, nuevoTelefono, nuevoEmail);
